...
public sealed class UserConfigurationService
{
    ...
    public bool LogManagerErrorsAndDebug { get; private set; }
    ...
    public void SetLogManagerErrorsAndDebug(bool logManagerErrorsAndDebug)
    {
        if (LogManagerErrorsAndDebug == logManagerErrorsAndDebug) return;

        LogManagerErrorsAndDebug = logManagerErrorsAndDebug;
        Save();
    }
    ...
    private void Load()
    {
        ...
        try
        {
            ...
            LogManagerErrorsAndDebug = obj["logManagerErrorsAndDebug"]?.GetValue<bool?>() ?? false;
        ...
        catch (Exception ex) when (ex is IOException or UnauthorizedAccessException or JsonException)
        {
            ...
            LogAppLaunchAndExit = false;
            LogManagerErrorsAndDebug = false;
            AutomaticDataBackupsWarningAcknowledged = false;
            CustomDataBackupLocation = null;
