...
public class AverageColorToBrushConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        var gradientBrush = new LinearGradientBrush
        {
            ...
            GradientStops =
            {
                new GradientStop(Color.FromArgb(255, baseColor.R, baseColor.G, baseColor.B), 0.7),
                new GradientStop(Color.FromArgb(255, fallbackColor.R, fallbackColor.G, fallbackColor.B), 0.71)
            }
        };
