...
public sealed class MainWindowDesignData
{
    ...
    public MainWindowDesignData()
    {
        ...
        {
            new SortOption("Active (Active → Inactive)", (nameof(ModListItemViewModel.ActiveSortOrder), ListSortDirection.Ascending), (nameof(ModListItemViewModel.NameSortKey), ListSortDirection.Ascending), (nameof(ModListItemViewModel.ModId), ListSortDirection.Ascending)),
            new SortOption("Name", (nameof(ModListItemViewModel.NameSortKey), ListSortDirection.Ascending), (nameof(ModListItemViewModel.ModId), ListSortDirection.Ascending)),
